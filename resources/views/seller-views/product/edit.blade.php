                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" {{$lang == 'en'? 'required':''}} name="name[]"
                                               ...
                                               class="form-control" placeholder="{{ \App\CPU\translate('new_product') }}" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <div class="mb-2 d-flex flex-wrap gap-1">
                                        ...
                                        <small class="badge-soft-info"> ( {{ \App\CPU\translate('optional')}}, {{\App\CPU\translate('please_provide_embed_link_not_direct_link') }} )</small>
                                    </div>

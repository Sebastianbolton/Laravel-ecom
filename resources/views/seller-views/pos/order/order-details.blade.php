                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    <div class="d-flex flex-column gap-2">
                                                        <img src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$detail->product['thumbnail']}}" onerror="this.src='{{asset('assets/back-end/img/160x160/img2.jpg')}}'" class="avatar avatar-60 rounded" alt="">

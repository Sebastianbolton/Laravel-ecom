                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{\App\CPU\translate('OTP_verification')}}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{\App\CPU\translate('order_verification')}}<span class="text-danger">*</span></label>
                        ...
                        <div class="card-body d-flex flex-wrap gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">{{ strtoupper($data->primary) }}</div>
                            ...
                            <div class="form-group">
                                ...
                                class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">{{ strtoupper($data->secondary) }}</div>
                            ...
                            <div class="form-group">
                                <input type="color" name="primary_light" value="{{ isset($data->primary_light) ? $data->primary_light : '#CFDFFB' }}"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">#CFDFFB</div>
                                    <label class="title-color text-capitalize">{{\App\CPU\translate('Primary_Light_Color')}}</label>
                                </div>
                            </div>
                            @endif
                        </div>
